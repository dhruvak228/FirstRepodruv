...
CREATE TABLE `faculty_attendance` (
  ...
  `present` time NOT NULL,
  PRIMARY KEY (`fac_id`,`working`),
  CONSTRAINT `fid_fk` FOREIGN KEY (`fac_id`) REFERENCES `faculty` (`fid`) ON UPDATE CASCADE
...
-- Dump completed on 2022-12-24 15:30:24
